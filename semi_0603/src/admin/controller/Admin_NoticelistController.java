...
public class Admin_NoticelistController extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ArrayList<Admin_NoticeVo> list=dao.publiclist(startRow, endRow,field,keyword);
		...
		Admin_NoticeDao dao1=new Admin_NoticeDao();
		int startRow1=(pageNum1-1)*10+1;
		int endRow1=startRow1+9;
		ArrayList<Admin_NoticeVo> list1=dao1.privatelist(startRow1, endRow1,field1,keyword1);
		...
		req.setAttribute("content","/admin/admin_content/board/noticelist.jsp");

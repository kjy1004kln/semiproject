...
public class User_OuterListController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ArrayList<Admin_ProductVo2> list=dao.outerbest4();//베스트
		
		int pageCount=(int)Math.ceil(dao.outergetCount()/16.0);
		ArrayList<Admin_ProductVo2> list1=dao.outerlist(startRow, endRow);//전체 상품

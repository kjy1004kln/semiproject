...
<table class="table">
	...
	<tr class="active">
		...
		<td><script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
<!--             // 팝업에서 검색결과 항목을 클릭했을때 실행할 코드를 작성하는 부분입니다.
            // 예제를 참고하여 다양한 활용법을 확인해 보세요. -->
        	<input type="text" name="postcode" placeholder="우편번호">
        	<input type="button" onclick="execDaumPostcode()" value="우편번호 찾기"><br>
        	<input type="text" name="roadAddress" placeholder="도로명주소">
        	<input type="text" name="jibunAddress" placeholder="지번주소">

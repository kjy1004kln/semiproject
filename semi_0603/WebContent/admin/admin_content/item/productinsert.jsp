...
<img src="<%=request.getContextPath()%>/admin/img/j4.png" style="position:absolute; top:50px; left:400px;">
 <form class="well form-horizontal" enctype="multipart/form-data" action="<%=request.getContextPath()%>/admin/product/upload" method="post" id="test_form" >
	<fieldset>
     ...
     <div class="control-group">
      ...
      <div class="control-group">
     	...
     	<div class="controls">
     		<div id="large_img1" class="border border-success" style="position: absolute; top:330px; left:50px; width:400px;height:500px;"></div>
     	</div>
     </div>
     <div class="control-group">
